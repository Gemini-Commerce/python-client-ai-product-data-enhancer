...
class AiproductdataenhancerFillProductDataCheckResponse(BaseModel):
    ...
    status: Optional[AiproductdataenhancerJobStatus] = AiproductdataenhancerJobStatus.UNKNOWN
    ...
    __properties: ClassVar[List[str]] = ["productDataFilled", "confidenceRate", "completionRate", "status", "error", "imageUrls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": obj.get("status") if obj.get("status") is not None else AiproductdataenhancerJobStatus.UNKNOWN,
            "error": AiproductdataenhancerError.from_dict(obj["error"]) if obj.get("error") is not None else None,
